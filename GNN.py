# reminder to fix the input conversion input between convolution layers and fully connected layers baka >w<
# PWEASE FIX INPUT CONVEWSION >W< AWSO OWGANIZE THE WAYER DATA SO THAT WOU ONWY NEED TO ENTEW THE LAWER TYPE AND GWADIENT AND LAYER OWTPOUT AWE AWTOMATICALLY CHOWSEN AND CAWCULATED
